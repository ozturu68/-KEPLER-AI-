...
def evaluate_model(
    y_true: np.ndarray, y_pred: np.ndarray, y_pred_proba: np.ndarray | None = None, dataset_name: str = "Dataset"
) -> dict:
    """
...
def compare_metrics(train_metrics: dict, val_metrics: dict, test_metrics: dict | None = None):
    """
